...
public class AppleInfoDialog extends Dialog {
    ...
    public AppleInfoDialog(@NonNull Context context, int themeResId) {
    ...
    public AppleInfoDialog setMessage(String msg) {
        if (msg != null) {
    ...
    public AppleInfoDialog setPositiveButton(final String text, final OnMyDialogButtonClickListener listener) {
        if (text != null) {
    ...
    public AppleInfoDialog setNegativeButton(String text, final OnMyDialogButtonClickListener listener) {
        if (text != null) {
